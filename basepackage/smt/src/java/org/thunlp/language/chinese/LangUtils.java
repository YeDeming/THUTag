...
public class LangUtils {
	...
	static {
		...
		String pat = "[" + ChineseLanguageConstants.ALL_MARKS[0] + ChineseLanguageConstants.ALL_MARKS[1]
	 ...
	 * character, it also includes TAB, space in Chinese full width letter and
	 * other special characters which appear as a white space. Spaces in the
	...
	public static String removePunctuationMarksExcept(String text, String exception) {
		String pat = "[" + ChineseLanguageConstants.ALL_MARKS[0].replaceAll(exception, "")
				+ ChineseLanguageConstants.ALL_MARKS[1].replaceAll(exception, "").replace("\\", "\\\\")
