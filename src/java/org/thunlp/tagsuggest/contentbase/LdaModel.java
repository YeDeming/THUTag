...
public class LdaModel {
   ...
   * @throws IOException
   */
  public LdaModel(InputStream in) throws IOException {
  ...
  public static class WordDocument  implements Serializable{
    public WordDocument(String [] words) {
      this.words = words;
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Training.
  public void train(List<WordDocument> docs, int numIterations) {
  ...
  public void initializeTopics(WordDocument d) {
   ...
   */
  public double inference(WordDocument d, double [] pzd) {
    initializeTopics(d);
  ...
  protected double gibbsSampling(WordDocument d) {
    double loglikelihood = 0;
